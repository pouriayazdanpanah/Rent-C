            ...
            <div class="col-md-12">
                <div class="card border-0 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form class="form-row" action="{{route('host.registration.create.location')}}" method="post">
                            @csrf
                            <div class="form-group col-md-8">
                                <label for="formatted_address">{{__('Address')}}<sup>*</sup></label>
                                <input type="text" name="formatted_address" class="form-control" placeholder="Enter listing address">
                            </div>
                            <div class="form-group col-md-4">
                                <label for="municipality_zone">{{__('Municipality zone')}}<small>(optional)</small></label>
                                <input type="text" name="municipality_zone" class="form-control" placeholder="Enter your aria">
                            </div>
                            <div class="form-group col-md-4">
...
@section('script')
    <script>
        ...
        map.on('click', function(e) {
            ...
            $.ajax({
                type:'Post',
                url:'/host/registration/find-location',
