                   ...
                   <div class="row mt-5">
                       @if(!$favorites->isEmpty())
                           @foreach($favorites as $favorite)
                               @php $product = $favorite->favoriteable;@endphp
                               <div class="col-md-4 mb-3">
                                   <div class="card border-0 shadow-sm">
                                       <img src="{{render_image_cover_URL_attachment_id($product->id)}}" class="card-img-top">
                                       <div class="card-body">
                                           <div class="container">
                                               <div class="row ">
