@component('admin.content',['title'=>'Category'])
    @slot('breadcrumb')
        <li class="breadcrumb-item"><a href="{{route('home')}}">Home</a></li>
        <li class="breadcrumb-item active"><a href="#">Performance</a></li>
        <li class="breadcrumb-item active"><a href="#">Structure</a></li>
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                <div class="modal-header border-0">
                                    <h5 class="modal-title" id="addFeatureLabel">Add Category</h5>
                                ...
                                <form action="{{route('admin.category.store')}}" method="post">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <label for="feature">{{__('Category name')}}</label>
                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    <td>{{$category->id}}</td>
                                    <td>{{$category->name}}</td>
                                    <td>{{$category->count_of_use}}</td>
                                    <td>{{$category->created_at}}</td>
                                    <td>
                                        <div class="d-flex">
                                            {{--                                  @can('edit-permissions')--}}

                                            <button href="" class="border-0 bg-transparent " data-toggle="modal" data-target="#feature{{$category->id}}"><i class="text-secondary fas fa-edit"></i></button>
                                            <div class="modal fade" id="feature{{$category->id}}" tabindex="-1" aria-labelledby="feature{{$category->id}}Label" aria-hidden="true">
                                                <div class="modal-dialog modal-dialog-centered">
                                                    <div class="modal-content">
                                                        <div class="modal-header border-0">
                                                            <h5 class="modal-title" id="feature{{$category->id}}Label">Edit Category</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form action="{{route('admin.category.update',$category->id)}}" method="post">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    ...
                                                                    <script>
                                                                        $(function () {
                                                                            $('#feature{{$category->id}}').modal('show')
                                                                        })
                                                                    </script>
                                                                    <span class="invalid-feedback">
                                                                            <strong>{{ $message }}</strong>
